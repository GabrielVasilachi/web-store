...
import { FitStudioPage } from './pages/FitStudioPage'
import './App.css'
...
function App() {
  ...
  return (
    ...
    >
      <div className="app-shell" id={page === 'home' ? undefined : 'top'}>
        <CustomCursor />
        <Header
          page={page}
          cartCount={cartCount}
        ...
        <main id="main" tabIndex={-1}>
          {page === 'lookbook' ? (
            ...
            <FitStudioPage onAddToCart={addToCart} />
          ) : (
            <>
